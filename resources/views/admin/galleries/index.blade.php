                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                        <div class="flex items-center gap-2">
                            ...
                            <form method="POST" action="{{ route('admin.galleries.destroy', $gallery) }}" class="inline delete-form" data-confirm="Yakin ingin menghapus gallery ini beserta semua gambarnya?">
                                @csrf
                                @method('DELETE')
